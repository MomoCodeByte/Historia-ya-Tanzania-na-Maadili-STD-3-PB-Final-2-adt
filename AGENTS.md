...
**Historia ya Tanzania na Maadili** — Hiki ni kitabu cha mwanafunzi cha somo la Historia ya Tanzania na Maadili kwa Darasa la Tatu, kilichoandaliwa na Taasisi ya Elimu Tanzania kwa wanafunzi wa shule za msingi Tanzania Bara. Kimeandikwa kwa lugha ya Kiswahili na kinahusu historia ya Tanzania, urithi wa taifa, haki na wajibu wa mtoto, maadili ya jamii, maarifa na ujuzi wa asili, pamoja na asili za jamii za Watanzania na ushirikiano wa kijamii. Maudhui yake yanaonesha mwelekeo wa kufundisha kwa vitendo kupitia matini, picha, kazi za kufanya na mazoezi, huku yakisisitiza uzalendo, utu, heshima, umoja, uadilifu na kuthamini rasilimali na utamaduni wa Tanzania.
...
```
Historia-ya-Tanzania-na-Maadili-STD-3-PB-Final-2/
├── adt/                              # THE WEB APP
...
├── Historia-ya-Tanzania-na-Maadili-STD-3-PB-Final-2.db                    # SQLite database (pipeline state)
├── Historia-ya-Tanzania-na-Maadili-STD-3-PB-Final-2.pdf                   # Original source PDF
...
```json
[
  { "section_id": "pg001_sec001", "href": "index.html", "page_number": 3 },
...
{
  "pg001_gp001_tx001": "",
  "pg001_im001": "Cheti cha uthibati cha kitabu, kilichotolewa na Wizara ya Elimu, Sayansi na Teknolojia. Kinaonyesha kuwa kitabu cha Historia ya Tanzania na Maadili Darasa la Tatu kimeidhinishwa kutumika shuleni.",
  "gl001": "adabu",
  "gl001_def": "Mwenendo mzuri unaoonesha heshima na ustaarabu.",
  "qz001_que": "Historia ya Tanzania ni elimu kuhusu nini?",
  "qz001_o0": "1) Michezo ya shule",
  "qz001_o0_exp": "❌ Si jibu sahihi. Michezo ya shule ni sehemu ya maisha ya shule, lakini si maana kuu ya historia ya Tanzania."
}
```
...
```json
{
  "adabu": {
    "word": "adabu",
    "definition": "Mwenendo mzuri unaoonesha heshima na ustaarabu.",
...
<section role="activity" data-section-type="activity_quiz" data-id="qz001"
    ...
    <p data-id="qz001_que">Historia ya Tanzania ni elimu kuhusu nini?</p>

    <label data-activity-item="qz001_o0"
           data-explanation="❌ Si jibu sahihi. Michezo ya shule ni sehemu ya maisha ya shule, lakini si maana kuu ya historia ya Tanzania." data-explanation-id="qz001_o0_exp">
        <input type="radio" name="qz001" value="qz001_o0" class="sr-only" />
        <span data-id="qz001_o0">1) Michezo ya shule</span>
    </label>
    <!-- more options... -->
</section>
...
| Original PDF | `Historia-ya-Tanzania-na-Maadili-STD-3-PB-Final-2.pdf` |
| Pipeline database | `Historia-ya-Tanzania-na-Maadili-STD-3-PB-Final-2.db` (SQLite) |
